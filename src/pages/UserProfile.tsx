...
import Checkbox from "../components/elements/checkbox/CheckBoxWithLabel";
...
const ClientsEdit = () => {  
    ...
    const [ResetPasswordIsVisible, setResetPasswordIsVisible] = useState(false);
    
    return ( 
        <>

            <BaseModal
            open={ResetPasswordIsVisible}
            modalType={ModalList.ResetPassword}
            subTitle={"Linkbynet"}
            onClose={setResetPasswordIsVisible}
            />
                    ...
                    <SearchCol>
                        <Row>
                            <Col className="subHeaderCaption" s={12} m={12} l={12}>
                                <MainCaption>SUPER ADMIN TEST</MainCaption>
                                <p>Edit your profile. These fields will be reflected in your forms.</p>
                            </Col>
                        </Row>
                    </SearchCol>
                            ...
                            <Col s={12} m={9} l={9}>
                                <Row className="mb-0">
                                    ...
                                    <Col s={12} m={12} l={12} className="smBtn">
                                        <CommonButton buttonText="Change Password" onClick={()=>setResetPasswordIsVisible(true)} icon={Icons.KeyIcon}/>
                                    </Col>
                                    <Col s={12} m={12} l={12}>
                                    ...
                                    <Col s={12} m={12} l={12} className="subHeaderCaption">
                                        ...
                                        <img className="signatureImage" src={Icons.SignatureImg} alt="Image"></img>
