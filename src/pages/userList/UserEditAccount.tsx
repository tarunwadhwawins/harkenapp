                ...
                <InnerContentWrapper>
                    <SearchCol>
                        <Row>
                            <Col className="subHeaderCaption" s={12} m={12} l={12}>
                                <MainCaption>WHITEWATER TECH</MainCaption>
                            </Col>
                        </Row>
                    </SearchCol>
                    ...
                    <FormFieldWrapper>
                        <Row>
                            ...
                            <Col s={12} m={12} l={12}>
                                <SubCaption className="mb-2">CONTACT</SubCaption>
                            </Col>
                            ...
                            <Col s={12} m={12} l={7}>
                                <Row>
                                    ...
                                    <Col s={12} m={6} l={4} className="mb-2 leftAlign">
                                        <label className="chooseColorFieldLable">Choose Primary Color</label>
                                        <ChooseColorField className="colorPicker">                                    
                            ...
                            <Col s={12} m={12} l={12}>
                                <SubCaption className="mb-2">Other Administrators</SubCaption>
                            </Col>
                            <TableWrapper>
                                <Table responsive>
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td data-label="E-mail">admin@whitewater.dev</td>
                                            <td data-label="Status ">Active</td>
                                        </tr>
                                        <tr>
                                            <td data-label="Name">Finch</td>
                                            <td data-label="E-mail">finchQA1@gmail.com</td>
                                            <td data-label="Status ">Active</td>
                                        </tr>
                                        <tr>
                                            <td data-label="Name">gagan</td>
                                            <td data-label="E-mail">testgagan@yopmail.com</td>
                                            <td data-label="Status ">Active</td>
                                        </tr>
                                        <tr>
                                            <td data-label="Name">Mahesh</td>
                                            <td data-label="E-mail">manish123@whitewater.dev</td>
                                            <td data-label="Status ">Active</td>
                                        </tr>
                                    </tbody>
                                </Table>
