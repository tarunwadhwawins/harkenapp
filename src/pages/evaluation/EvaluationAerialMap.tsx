            ...
            <SearchCol>
                <Row>
                    <Col className="subHeaderCaption" s={12} m={12} l={12}>
                        <MainCaption>Aerial Map</MainCaption>
                ...
                <GoogleMap>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3144054.9166416307!2d-102.38642142130658!3d39.91358654133142!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x54eab584e432360b%3A0x1c3bb99243deb742!2sUnited%20States!5e0!3m2!1sen!2sin!4v1651484123599!5m2!1sen!2sin" width="600" height="450"></iframe>
                    <div className="detailPopUp">
                        ...
                        <Col className="rightAlign"> 
                            <GrayButton onClick={()=>navigate(RoutePath.EVALUATIONPROPERTYBOUNDARIES)}  icon={Icons.Back}/> 
                            <CommonButton onClick={()=>navigate(RoutePath.EVALUATIONAREAINFO)} buttonText="Save & Continue" />                      
                            <GrayButton onClick={()=>navigate(RoutePath.EVALUATIONAREAINFO)}  buttonText="Skip"/>                       
                        </Col>
                    </div>
                </GoogleMap> 
...
export default EvaluationAerialMap;
