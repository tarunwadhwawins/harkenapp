...
import { RemoveFieldWrap } from "../../../pages/UserProfile";
                    ...
                    <Row>
                        ...
                        <Col s={12} m={12} l={12}>
                            <AddOnBlock>
                                ...
                                <Row className="addExtraPropertyCol">
                                    <Col s={10} m={4} l={4}>
                                        <FormControll className="asteriskSign searchField">
                                            <SelectField label="Property Type" option={propertyTypeOptions}></SelectField>            
                                        </FormControll>
                        ...
                        <Col s={12} m={6} l={6}>
                            <FormControll>
                                <InputLabelfield label="uilt Year"></InputLabelfield>
                            </FormControll>
                        </Col>
                        <Col s={12} m={6} l={6}>
                            <FormControll>
                        ...
                        {/* <Col s={12} m={12} l={12}>
                            <AddOnBlock>
                                <Row>
                                    ...
                                    <Col s={12} m={12} l={12}>
                                        <PopUpactionBtn>
                                            <CommonButton buttonText="Add Seller" icon={Icons.PlusIcon}/>
                                        </PopUpactionBtn>
                                    </Col>
                                </Row>                                
                            </AddOnBlock>                            
                        ...
                        {/* <Col s={12} m={12} l={12}>
                            <AddOnBlock>
                                <Row>
                                    ...
                                    <Col s={12} m={12} l={12}>
                                        <PopUpactionBtn>
                                            <CommonButton buttonText="Add Buyer" icon={Icons.PlusIcon}/>
                                        </PopUpactionBtn>
                                    </Col>
                                </Row>                                
                            </AddOnBlock>                            
